        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            Column(
                ...
                ContentSection(title = "1. Assertive Sentence (Simple sentence.)", titleColor = Color(0xFFF57C00)) {
                    ...
                    RuleBox("Note:- Affirmative, Negative तथा Interrogative का अध्ययन tense वाले भाग मे है ।")
                }
                ...
                ContentSection(title = "Negative Sentence (Imperative)", titleColor = Color(0xFFC62828)) {
                    ...
                    ExampleItem("Negative Examples:", "• Do not talk in the class.\n  (कक्षा मे बात चीत मत करो )\n• Never tell a lie.\n  ( कभी झूठ मत बोलो )")
                }
                ...
                ContentSection(title = "5. Optative sentence (इच्छा सूचक)", titleColor = Color(0xFF388E3C)) {
                    ColoredPoint("ईश्वर से प्रार्थना अथवा इच्छा प्रकट करने वाले वाक्यों को Optative कहते है । इन वाक्यों को 'may' से प्रारंभ करते है तथा वाक्य के अंत मे चिन्ह ( ! ) लगाते है ।", 1)
                    
                    ExampleItem("Optative Example:", "भगवान तुम्हें लंबी आयु दे !\nMay you live long !")
                }
